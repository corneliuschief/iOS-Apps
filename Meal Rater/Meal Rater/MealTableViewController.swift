...
//  Food Tracker
//
//  Created by Elaine Breen on 28/08/2017.
...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //Load any saved meals else load the sample meals
    ...
    */
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Chicken", rating: 4, photo: photo1) else {
            fatalError("Unable to instantiate meal1")
        }
        
        guard let meal2 = Meal(name: "Cabbage", rating: 3, photo: photo2) else {
            fatalError("Unable to instantiate meal2")
        }
        
        guard let meal3 = Meal(name: "Snack", rating: 5, photo: photo3) else {
            fatalError("Unable to instantiate meal3")
        }
        
        // Add sample meals to the meals array
